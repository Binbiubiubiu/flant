...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(year, month) => "${year}/${month}";

  static String m1(maxRange) => "Choose no more than ${maxRange} days";

  static String m2(count) => "You have ${count} coupons";

  static String m3(condition) => "At least ${condition}";

  static String m4(discount) => "${discount}% off";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "AddressEditDetail_label":
            MessageLookupByLibrary.simpleMessage("Address"),
        "AddressEditDetail_placeholder":
            MessageLookupByLibrary.simpleMessage("Address"),
        "AddressEdit_addressEmpty":
            MessageLookupByLibrary.simpleMessage("Address can not be empty"),
        "AddressEdit_area": MessageLookupByLibrary.simpleMessage("Area"),
        "AddressEdit_areaEmpty": MessageLookupByLibrary.simpleMessage(
            "Please select a receiving area"),
        "AddressEdit_areaPlaceholder":
            MessageLookupByLibrary.simpleMessage("Area"),
        "AddressEdit_defaultAddress":
            MessageLookupByLibrary.simpleMessage("Set as the default address"),
        "AddressEdit_namePlaceholder":
            MessageLookupByLibrary.simpleMessage("Name"),
        "AddressEdit_postal": MessageLookupByLibrary.simpleMessage("Postal"),
        "AddressEdit_postalEmpty":
            MessageLookupByLibrary.simpleMessage("Wrong postal code"),
        "AddressEdit_telPlaceholder":
        ...
        "ContactCard_addText":
            MessageLookupByLibrary.simpleMessage("Add contact info"),
        "ContactList_addText":
        ...
        "PullRefresh_loosing":
            MessageLookupByLibrary.simpleMessage("Loose to refresh..."),
        "PullRefresh_pulling":
        ...
        "nameEmpty":
            MessageLookupByLibrary.simpleMessage("Please fill in the name"),
        "nameInvalid": MessageLookupByLibrary.simpleMessage("Malformed name"),
        "save": MessageLookupByLibrary.simpleMessage("Save"),
        "tel": MessageLookupByLibrary.simpleMessage("Phone"),
        "telEmpty":
            MessageLookupByLibrary.simpleMessage("Please fill in the tel"),
        "telInvalid":
            MessageLookupByLibrary.simpleMessage("Malformed phone number")
      };
}
